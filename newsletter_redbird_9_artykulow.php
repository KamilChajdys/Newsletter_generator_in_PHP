...
$szablon_testowy = '<p style="text-align: center; color: #3e3e3e; font-family: Arial,Helvetica,sans-serif; font-size: 12px; padding:20px;">Jeśli nie widzisz poprawnie poniższej wiadomości, <a href="" style="font-size: 12px; color: #3e3e3e; text-decoration: none;" target="_blank">otwórz ją w przeglądarce</a></p>
		<table align="center" bgcolor="#F8F8F8" border="0" cellpadding="0" cellspacing="0" style="width:650px;display:block; background:#F8F8F8;">
            <tbody><tr>
                ...
                <table width="650px" border="0" style="width:650px;">
                    <tbody><tr>
                        <td align="right" style="text-decoration:none; font-family: Calibri; font-size: 15px; font-style: italic; padding-right: 20px">Oferta ważna w dniach 14.05.2014 - 19.05.2014</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" style="width:650px; display:block;" width="650px">
                            ...
                            <tbody><tr align="center" style="width:650px;" width="650px">
                                <td><a align="center" href="http://www.zabierzkoniecznie.pl/Filtr-do-wody-czy-nowa-alternatywa--cinfo-pol-30.html" style="border:none;color:#74ae3b;text-decoration:none;font-size:12px;display:block" title="Zobacz" target="_blank">
                                <img align="center" alt="" name="" width="650px" src="https://redi.iai-shop.com/data/include/cms/newsletter/2014-06-03/Steripen_informacje_01.jpg" style="width:650px;"></a></td>
                                
                            </tr>
                            <tr align="center" style="width:650px;" width="650px">
                                <td><a align="center" href="http://www.zabierzkoniecznie.pl/Filtr-do-wody-czy-nowa-alternatywa--cinfo-pol-30.html" style="border:none;color:#74ae3b;text-decoration:none;font-size:12px;display:block" title="Zobacz" target="_blank">
                                <img align="center" alt="" name="" width="650px" src="https://redi.iai-shop.com/data/include/cms/newsletter/2014-06-03/Steripen_informacje_02.jpg" style="width:650px;"></a></td>
                                
                            </tr>
                            <tr align="center" style="width:650px;" width="650px">
                                <td><a align="center" href="http://www.zabierzkoniecznie.pl/Filtr-do-wody-czy-nowa-alternatywa--cinfo-pol-30.html#jak_to_dziala" style="border:none;color:#74ae3b;text-decoration:none;font-size:12px;display:block" title="Zobacz" target="_blank">
                                <img align="center" alt="" name="" width="650px" src="
                               https://redi.iai-shop.com/data/include/cms/newsletter/2014-06-03/Steripen_informacje_03.jpg" style="width:650px;"></a></td>
                                
                            </tr>
                            <tr align="center" style="width:650px;" width="650px">
                                <td><a align="center" href="http://www.zabierzkoniecznie.pl/Filtr-do-wody-czy-nowa-alternatywa--cinfo-pol-30.html#ktory_filtr_wybrac" style="border:none;color:#74ae3b;text-decoration:none;font-size:12px;display:block" title="Zobacz" target="_blank">
                                <img align="center" alt="" name="" width="650px" src="https://redi.iai-shop.com/data/include/cms/newsletter/2014-06-03/Steripen_informacje_04.jpg" style="width:650px;"></a></td>
...
$szablon_uzupelniony = '
		<p style="text-align: center; color: #3e3e3e; font-family: Arial,Helvetica,sans-serif; font-size: 12px; padding:20px;">Jeśli nie widzisz poprawnie poniższej wiadomości, <a href="" style="font-size: 12px; color: #3e3e3e; text-decoration: none;" target="_blank">otwórz ją w przeglądarce</a></p>
		<table align="center" bgcolor="#F8F8F8" border="0" cellpadding="0" cellspacing="0" style="width:650px;display:block; background:#F8F8F8;">
            <tbody><tr>
                <td>
                <table width="650px" border="0" style="width:650px;">
...
<div style="width: 300px; float: left; margin-bottom: 30px;">
    <form method="post" action="newsletter_redbird_9_artykulow.php">
